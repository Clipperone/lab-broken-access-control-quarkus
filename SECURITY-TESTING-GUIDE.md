...
| **Gerarchia di ruoli** | `tenant` | accesso al documento solo se il ruolo dell'utente è ≥ al ruolo soglia dell'owner | [OfficeDocumentResourceTest](src/test/java/org/fugerit/java/demo/lab/broken/access/control/OfficeDocumentResourceTest.java) |
| **Visibilità multi-parte** (relationship-based) | `tenant` | visibile a creatore, destinatario e admin dello stesso ufficio | [AppointmentResourceTest](src/test/java/org/fugerit/java/demo/lab/broken/access/control/AppointmentResourceTest.java) |
| **Autorizzazione temporale** | `temporal` | eliminazione consentita solo se mancano > 24h all'appuntamento; solo dal creatore | [AppointmentResourceTest](src/test/java/org/fugerit/java/demo/lab/broken/access/control/AppointmentResourceTest.java) |
